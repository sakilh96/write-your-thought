...
import { getUser } from "pages/actions/userActions";
...
const QuickMenu = () => {
    ...
    const oneUser = userStoredata.user;
            ...
            <Dropdown as="li" className="ms-2">
                <Dropdown.Toggle
                    ...
                    <div className="avatar avatar-md avatar-indicators avatar-online">
                        <Image alt="avatar" src={oneUser?.profile_pic} className="rounded-circle" />
                    </div>
                </Dropdown.Toggle>
                <Dropdown.Menu
                    ...
                    <Dropdown.Item as="div" className="px-4 pb-0 pt-2" bsPrefix=' '>
                            <div className="lh-1 ">
                                <h5 className="mb-1"> {oneUser?.name}</h5>
                                <Link href="/admin/pages/profile" className="text-inherit fs-6">View my profile</Link>
                            </div>
                            <div className=" dropdown-divider mt-3 mb-2"></div>
                    </Dropdown.Item>
                  
                    <Dropdown.Item onClick={() => handleDropdownClose('/admin')}>
...
// Wrap the QuickMenu component with Provider and pass the Redux store as a prop
export default function QuickMenuWrapper() {
    return (
